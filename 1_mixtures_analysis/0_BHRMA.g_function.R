...
# 1. Options for jags estimation in function call (sample iterations, burn-in, number of chains)
# 2. Option for binary outcome
# 3. incorporate g-prior with assumption of constant XtX over imputation
